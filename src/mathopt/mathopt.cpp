...
void MathOpt::getDualMembershipLP(
	 ...
	 const bool &normalization ///< True if the LP is normalized (preventing unboundedness in case of
										///< feasibility)
) {
  /**
	...
	* in @p ConvexModel with the missing vertices and rays. In case @p normalization is
