...
void MathOpt::OuterLCP::addChildComponents(const std::vector<short int> encoding) {
  /**
	...
	* MathOpt::OuterLCP::addComponent.
	*
	* @internal Analogous to MathOpt::PolyLCP::addPoliesFromEncoding
	*
	*/
...
bool MathOpt::OuterLCP::addComponent(
	 ...
	 vec_Vec *custbi    ///< If custom polyhedra vector is used, pointer to the RHS
							  ...
							  /**
								...
								* MathOpt::OuterLCP::Ai and MathOpt::OuterLCP::bi (or @p custAi and @p custbi).
								*
								* As a note to remember, 0 means, no branching is done on the said
								* complementarity condition.
								*
								* @internal Analogous to MathOpt::PolyLCP::addPolyFromEncoding
								*/
) {
...
bool MathOpt::OuterLCP::checkComponentFeas(
  ...
  /**
	...
	* MathOpt::OuterLCP::FeasibleComponents and MathOpt::OuterLCP::InfeasibleComponents
	*/
