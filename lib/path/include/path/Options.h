...
FUN_DECL(void)
Options_SetBoolean(const Options_Interface *i, const char *option, const Boolean value);
FUN_DECL(void) Options_SetInt(const Options_Interface *i, const char *option, const int value);
FUN_DECL(void)
Options_SetDouble(const Options_Interface *i, const char *option, const double value);
FUN_DECL(void) Options_SetOther(const Options_Interface *i, const char *option, const int value);
...
FUN_DECL(Boolean) Options_GetBoolean(const Options_Interface *i, const char *option);
