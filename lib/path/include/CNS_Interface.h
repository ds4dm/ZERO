...
FUN_DECL(Void) CNS_GetJ(CNS *c, Int *nz, Int **col, Int **len, Int **row, Double **data);
...
typedef struct {
  ...
  Void(CB_FPTR bounds)(Void *id, Int size, Double *x, Double *l, Double *u);

  Int(CB_FPTR function_evaluation)(Void *id, Int n, Double *x, Double *f);
  Int(CB_FPTR jacobian_evaluation)(Void *  id,
											  Int     n,
											  Double *x,
											  Int     wantf,
											  Double *f,
  ...
  Void(CB_FPTR variable_name)(Void *id, Int variable, Char *buffer, Int buf_size);
  Void(CB_FPTR constraint_name)(Void *id, Int constr, Char *buffer, Int buf_size);
