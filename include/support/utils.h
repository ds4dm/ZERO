...
namespace Utils {
  ...
  bool containsConstraint(arma::sp_mat &A, const arma::vec &b, const arma::vec &lhs,
                          const double &rhs, const double tol = 1e-6);
  bool containsConstraint(arma::sp_mat &A, const arma::vec &b, const arma::sp_mat &lhs,
                          const double &rhs, const double tol = 1e-6);
  arma::vec normalize(const arma::vec input);

  // Saving and retrieving an arma::vec
  void appendSave(const arma::vec &matrix, const std::string out, const std::string header = "",
                  bool erase = false);
  ...
  void appendSave(const arma::sp_mat &matrix, const std::string out, const std::string header = "",
                  bool erase = false);
  ...
  void appendSave(const std::vector<double> v, const std::string out, const std::string header = "",
                  bool erase = false);
  ...
  void appendSave(const unsigned int v, const std::string out, const std::string header = "",
                  bool erase = false);
