...
namespace Models {
  ...
  private:
	 ...
	 bool dataCheck(bool chkAllLeadPars = true, bool chkcountriesLL = true, bool chkMC_QP = true,
	                bool chkLeadConses = true, bool chkLeadRHSes = true,
	                bool chknImportMarkets = true, bool chkLocations = true,
	                bool chkLeaderLocations = true, bool chkLeadObjec = true) const;
	 ...
	 void WriteFollower(const unsigned int i, const unsigned int j, const std::string filename,
